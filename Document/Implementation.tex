...
\begin{figure} [H]
    ...
    \begin{subfigure} {0.5\textwidth}
        ...
        \label{fig:tables}
    \end{subfigure}
    \caption[Ground Truth Segmentation figures]{(a) Ground Truth Segmentation of a hallway in CloudCompare. Shown is the input cloud on the left and segmented planes on the right.
    Both are cropped and without ceilings for visualization purposes.
    (b) The provided ground truth considers these tables to be three separate objects. Within the context of
