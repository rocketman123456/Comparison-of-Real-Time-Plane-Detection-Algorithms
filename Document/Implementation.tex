...
The \textit{auditorium} scene has a total of 296 individual time frames, the \textit{conference room} scene has 113, the \textit{hallway} has a total of 174,
and the \textit{office} has 125 time frames. The FIN dataset, thereby, has a total of 708 time frames (see Table~\ref{tab:fin-stats}).
