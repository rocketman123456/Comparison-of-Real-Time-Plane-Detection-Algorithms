...
\textbf{\textcolor{red}{we calculate the precision..}}
\textbf{\textcolor{red}{we calculate the recall..}}

We calculate the \textit{F1-Score}, as it is the harmonic mean of the \textit{Precision} and the \textit{Recall}. In practice, this means that an algorithm
has to yield sufficient \textit{Precision} and \textit{Recall} results to score a sufficient \textit{F1-Score} . The \textit{F1-Score}, thereby, is the primary metric
...
\citeauthor{\cite{LimbergerOliveira2015HT3D}}~\cite{LimbergerOliveira2015HT3D} propose
...
Lastly, we set the plane isotropy tolerance $s_\beta$ to 6, as proposed in~\cite[Section~3.1]{\cite{LimbergerOliveira2015HT3D}}.
...
\subsubsection{OBRG}
\textbf{\textcolor{red}{die fucking parameter sind in tabelle 1+4 des papers}}
\textbf{\textcolor{red}{+3.1 rot markiert}}
\begin{table}[H]
    \centering
    \begin{tabular}{c|cccccc}
