...
\section{Protocol}
This work aims to determine the applicability of plane detection algorithms for AR/VR systems in a realistic environment. Therefore, we compare the algorithms selected in Chapter~\ref{chap:Concept}. 
