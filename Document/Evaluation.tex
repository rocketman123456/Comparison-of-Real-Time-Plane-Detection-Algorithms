...
The following two paragraphs detail the metrics we use in this evaluation. Note, that by using the term "time frame" or "time step", we refer to 
an the state of the point
\paragraph{Accuracy}
