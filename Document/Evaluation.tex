...
\label{par:time}
We are also interested in the real-time applicability of an algorithm.
...
Furthermore, we consider an algorithm to achieve \textit{real-time plane detection} ($RT_{calc}$) if its plane detection and post-processing steps run faster than $1s.$
