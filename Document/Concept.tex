...
% FIXME das ganze realsense SDK geraffel schöner formulieren
...
% FIXME Überleitung: "warum nutze ich realsense ros?" 
...
% FIXME  fair? -> we choose not to require a GPU to replicate our findings.
...
% FIXME seems repeating to me, having a paragraph per criterio to reference them here in one single sentence
