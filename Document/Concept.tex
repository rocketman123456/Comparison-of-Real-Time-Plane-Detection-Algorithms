...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{cccccc}
            ...
            OPS \cite{https://doi.org/10.48550/arxiv.1905.02553}                            & \ref{subsec:bg-ops}         & UPC                 & 3D-IN                 & CPU               & Y                  \\
...
\begin{figure}[H]
    ...
    \caption[Synthetic and Realistic Dataset Comparison]{A synthetic dataset (a) and a real office scene (b).
        The former is from the \textit{SegComp}~\cite{article} dataset, and the latter is from the 2D-3D-S~\cite{https://doi.org/10.48550/arxiv.1702.01105} dataset.
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{cccccc}
            ...
            \midrule
            2D-3D-S      \cite{https://doi.org/10.48550/arxiv.1702.01105}                                                                                                                                      & \ref{subsec:bg-stanford} & UPC                   & Y             & Y               & classes     \\
            ...
            ICL-NUIM    \cite{Handa_Whelan_McDonald_Davison_2014}                                                                                                                                       & \ref{subsec:bg-ICL}      & DI                    & Y             & Y               & trajectory  \\
...
Nevertheless, we cannot use the ground truth included in 2D-3D-S because it represents the segmented scene at the level of objects~\cite[Section~4.1]{https://doi.org/10.48550/arxiv.1702.01105} instead of focusing on planes within the scene.
...
Moreover, \citeauthor{https://doi.org/10.48550/arxiv.1702.01105}~\cite{https://doi.org/10.48550/arxiv.1702.01105} recorded the dataset with a static 360° camera. Therefore, the dataset is not entirely realistic, though being recorded in a real environment.
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.4\textwidth}
        ...
        \label{fig:finhw}
    \end{subfigure}
    \caption[FIN Dataset]{The recorded point clouds for each scene type: (a) \textit{auditorium}, (b) \textit{conference room}, (c) \textit{office} and (d) \textit{hallway}.
