...
The application then further processes those planes follwing the implied requirements of the system's use case.
...
Note that 3D inliers are hereafter referred to solely as \textit{inliers}.
