...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{c|c|c|c|c|c}
            ...
            \textbf{RSPD} \cite{Araújo_Oliveira_2020}                        & UPC                 & inliers               & CPU               & Y                  & \ref{subsec:bg-rspd}        \\
            \textbf{OPS} \cite{Sun_Mordohai_2019}                            & UPC                 & inliers               & CPU               & Y                  & \ref{subsec:bg-ops}         \\
            \textbf{3DKHT} \cite{LimbergerOliveira2015HT3D}                  & UPC                 & inliers               & CPU               & Y                  & \ref{subsec:bg-3dkht}       \\
            \textbf{OBRG} \cite{Vo_Truong-Hong_Laefer_Bertolotto_2015}       & UPC                 & inliers               & CPU               & Y                  & \ref{subsec:bg-obrg}        \\
            \textbf{PEAC} \cite{Feng_Taguchi_Kamat_2014}                     & OPC                 & inliers               & CPU               & Y                  & \ref{subsec:bg-peac}        \\
            \textbf{CAPE} \cite{Proença_Gao_2018}                            & OPC                 & $(n, d)$              & CPU               & Y                  & \ref{subsec:bg-cape}        \\
            \textbf{SCH-RG} \cite{Mols_Li_Hanebeck_2020}                     & OPC                 & inliers               & CPU               & Y                  & \ref{subsec:bg-schrg}       \\
            \textbf{D-KHT}  \cite{Vera_Lucio_Fernandes_Velho_2018}           & DI                  & inliers               & CPU               & Y                  & \ref{subsec:bg-dkht}        \\
            \textbf{DDFF} \cite{Roychoudhury_Missura_Bennewitz_2021}         & DI                  & inliers               & CPU               & Y                  & \ref{subsec:bg-ddff}        \\
            \textbf{PlaneNet} \cite{Liu_Yang_Ceylan_Yumer_Furukawa_2018}     & RGBI                & SM, $(n, d)$          & GPU               & Y                  & \ref{subsec:bg-planenet}    \\
