...
Note, that the final output of PlaneRecNet is a piecewise-planar reconstruction of a scene (see Subsection~\ref{subsec:planerecnet}).
However, modifying the architecture to return the segmentation masks would require minimal
...
\begin{table}[H]
    ...
    \begin{tabular}{c|c|c|c}
        \textbf{Plane Detection Algorithm}                               & \textbf{Input Data} & \textbf{Plane Format} & \textbf{Section}            \\ \hline %& \textbf{Learning-Based} \\ \hline%& \textbf{Availability} \\ \hline
        \textbf{RSPD} \cite{Araújo_Oliveira_2020}                        & UPC                 & inliers               & \ref{subsec:bg-rspd}        \\  %& N                       \\ %& Y                     \\ \hline
        \textbf{OPS} \cite{Sun_Mordohai_2019}                            & UPC                 & inliers               & \ref{subsec:bg-ops}         \\  %& N                       \\ %& Y                     \\ \hline
        \textbf{3DKHT} \cite{LimbergerOliveira2015HT3D}                  & UPC                 & inliers               & \ref{subsec:bg-3dkht}       \\  %& N                       \\ %& Y                     \\ \hline
        \textbf{OBRG} \cite{Vo_Truong-Hong_Laefer_Bertolotto_2015}       & UPC                 & inliers               & \ref{subsec:bg-obrg}        \\  %& N                       \\ %& Y                   \\ \hline
        \textbf{PEAC} \cite{Feng_Taguchi_Kamat_2014}                     & OPC                 & inliers               & \ref{subsec:bg-peac}        \\  %& N                       \\ %& Y                     \\ \hline
        \textbf{CAPE} \cite{Proença_Gao_2018}                            & OPC                 & $n, d$                & \ref{subsec:bg-cape}        \\  %& N                       \\ %& Y                     \\ \hline
        \textbf{SCH-RG} \cite{Mols_Li_Hanebeck_2020}                     & OPC                 & inliers               & \ref{subsec:bg-schrg}       \\  %& N                       \\ %& N                     \\ \hline
        \textbf{D-KHT}  \cite{Vera_Lucio_Fernandes_Velho_2018}           & DI                  & inliers               & \ref{subsec:bg-dkht}        \\  %& N                       \\ %& Y                     \\ \hline
        \textbf{DDFF} \cite{Roychoudhury_Missura_Bennewitz_2021}         & DI                  & inliers               & \ref{subsec:bg-ddff}        \\  %& N                       \\ %& Y                     \\ \hline
        \textbf{PlaneNet} \cite{Liu_Yang_Ceylan_Yumer_Furukawa_2018}     & RGBI                & $n, d$                & \ref{subsec:bg-planenet}    \\  %& Y                       \\ %& Y                     \\ \hline
        \textbf{PlaneRecNet} \cite{Xie_Shu_Rambach_Pagani_Stricker_2022} & RGBI                & SM                    & \ref{subsec:bg-planerecnet} \\  %& Y                       \\ %& Y                     \\ \hline
        \textbf{PlaneRCNN} \cite{Liu_Kim_Gu_Furukawa_Kautz_2019}         & RGBI                & $n, d$                & \ref{subsec:bg-planercnn}   \\  %& Y                       \\ %& Y                     \\ \hline
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{c|c|c|c|c|c}
        ...
        \textbf{SYNBEP}      \cite{schaefer19icra}                                                                                                                                            & OPC                   & N             & /               & planes      & \ref{subsec:bg-SYNBEP}   \\
        ...
        \textbf{SUN}         \cite{7298655}                                                                                                                                                   & DI                    & Y             & Y               & objects     & \ref{subsec:bg-SUN}      \\
    ...
    \label{tab:datasets}
\end{table}
\textbf{\textcolor{red}{strich drunter, ours (FIN)}}
