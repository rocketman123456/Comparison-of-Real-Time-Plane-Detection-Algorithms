...
As the name suggests, \textit{Plane Extraction using Spherical Convex Hulls} (SCH-RG) employs spherical convex hulls to
...
coplanar. The latter is determined through PCA. Therein, the mean and
