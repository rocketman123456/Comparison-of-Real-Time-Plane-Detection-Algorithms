...
\begin{table}[H]
    \centering
    \caption{Possible inputs for plane detection algorithms columns dedicated to the stored data, the memory layout, and whether the input type allows for invalid values.}
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{cccc}
            \toprule
