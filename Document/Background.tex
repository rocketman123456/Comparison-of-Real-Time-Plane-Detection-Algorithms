...
In this work, we use the Intel RealSense tracking camera T265 and the RGB-Depth camera D455. An excerpt of the camera 
...
% FIXME unterschied zwischen T265 und D455!
%  <=>
...
% FIXME Verweis auf survey oä für die klassifikation
\begin{itemize}
...
% FIXME wie würde Hough transform im kontext dieser arbeit aussehen? ~ analog zu letztem absatz von ransac und RG
...
% FIXME "neighboring points ist zu PC spezifisch"
...
\textcolor{red}{hier werde ich noch Precision, Recall und F1 erklären.}
