...
\label{subsec:bg-ops}
\textit{Oriented Point Sampling} (OPS)~\cite{Sun_Mordohai_2019} accepts an unorganized point cloud as input.


First, a sample of points is uniformly selected from the entire point cloud. Sample sizes of $\alpha_s \in [0.3\%,3\%]$ are used in the Evaluation in~\cite[Table~3]{Sun_Mordohai_2019}.
